...
<div class="btm-nav container mx-auto border">
  ...
  <a class:active={$page.url.pathname === '/buy-sell'} href="/buy-sell">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="h-5 w-5"
      fill="none"
  ...
  <a class:active={$page.url.pathname === '/data'} href="/data">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="h-5 w-5"
      fill="none"
  ...
  <a class:active={$page.url.pathname === '/guide'} href="/guide">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="h-5 w-5"
      fill="none"
