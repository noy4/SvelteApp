...
<header class="navbar shadow bg-base-100">
	<div class="flex-1">
		<button class="btn btn-ghost text-xl normal-case">Kuwa Coin</button>
	</div>

	<div class="flex-none">
		<!-- 🌞 sun icon -->
		<button class:hidden={theme === 'dark'} on:click={setDark}>
		...
		<!-- 🌙 moon icon -->
		<button class:hidden={theme !== 'dark'} on:click={setLight}>
			<svg class="fill-current w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
				><path
