...
<div class="hero min-h-screen not-prose" style="background-image: url(coin.jpeg);">
  ...
  <div class="hero-content text-center text-neutral-content">
    ...
    <svg
      ...
      ><path
        d="M831.872 340.864L512 652.672L192.128 340.864a30.592 30.592 0 0 0-42.752 0a29.12 29.12 0 0 0 0 41.6L489.664 714.24a32 32 0 0 0 44.672 0l340.288-331.712a29.12 29.12 0 0 0 0-41.728a30.592 30.592 0 0 0-42.752 0z" /></svg>
  </div>
</div>
